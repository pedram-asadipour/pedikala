    ...
    Sidemenu.prototype.menuItemClick = function(e) {
       if(!$("#wrapper").hasClass("enlarged")){
        ...
        if(!$(this).hasClass("subdrop")) {
          ...
          $(".pull-left i",$(this).parents(".has_sub:last")).removeClass("md-add").addClass("md-remove");
          $(".pull-left i",$(this).siblings("ul")).removeClass("md-remove").addClass("md-add");
        }else if($(this).hasClass("subdrop")) {
          $(this).removeClass("subdrop");
          $(this).next("ul").slideUp(350);
          $(".pull-left i",$(this).parent()).removeClass("md-remove").addClass("md-add");
        }
      } 
    },
