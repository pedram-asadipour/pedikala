...
oPaginate:{sFirst:"اولین",sLast:"اخرین",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"هیچ مقداری وجود ندارد",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ مقدار",sInfoEmpty:"نمایش 0 تا 0 از 0 مقدار",sInfoFiltered:"(فیلتر از بین _MAX_ مقدار)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ مقدار",sLoadingRecords:"لطفا منتظر بمانید...",sProcessing:"در حال آماده سازی...",sSearch:"فیتر : ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"هیچ مقداری با این فیلتر پیدا نشد"},oSearch:h.extend({},
