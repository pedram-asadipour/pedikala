...
{
    public partial class InitDataBaseWithProductCategoryTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageAlt = table.Column<string>(type: "nvarchar(225)", maxLength: 225, nullable: true),
                    ImageTitle = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
